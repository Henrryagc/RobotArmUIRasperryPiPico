...
class RobotArm:
    ...
    def move_base(self, position: int):        
        ...
        self.board.write(self.__encode_data(slef.ROBOT_BASE, position))
    ...
    def move_shoulders(self, position: int):
        ...
        #self.board.write(position.encode('UTF-8'))                
        self.board.write(self.__encode_data(slef.ROBOT_SHOULDERS, position))
    ...
    def move_arm_botton(self, position: int):
        ...
        #self.board.write(position.encode('UTF-8'))
        self.board.write(self.__encode_data(slef.ROBOT_ARM_BOTTOM, position))
    ...
    def move_arm_top(self, position: int):
        ...
        #self.board.write(position.encode('UTF-8'))
        self.board.write(self.__encode_data(slef.ROBOT_ARM_TOP, position))
    ...
    def move_arm_wrist(self, position: int):
        ...
        #self.board.write(position.encode('UTF-8'))
        self.board.write(self.__encode_data(slef.ROBOT_WRIST, position))
    ...
    def move_arm_gripper(self, position):
        ...
        self.board.write(self.__encode_data(slef.ROBOT_GRIPPER, position))
        print(f"Gripper  {position}")


    def __encode_data(robot_part: int, position: int) -> bytes:
